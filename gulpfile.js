...
gulp.task('scripts', function() {
  return gulp.src(['project.module.js', 'tasks/tasks.module.js', 'register/register.module.js', 'login/login.module.js', 'project.config.js', 'tasks/tasks.component.js', 'register/register.component.js', 'login/login.component.js'])
    .pipe(concat('all.js'))
    .pipe(gulp.dest('./dist/'));
});
